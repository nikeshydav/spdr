...
<div class="header_container">
  <div class="center_container">
    <div class="spdr_logo"><a href="index.php"><img src="images/spdr_logo.png" alt="SPDR Logo"/></a></div>
  ...
  <div class="game_container_shdow">
    <div class="center_container">
        ...
        <div class="email_container">
          <div class="email_header">
            ...
            <div class="email_header_right">
              <div class="email_header_right_content"> The information entered on this page will not be used to send unsolicited email, and will not be sold to a third party. Please read our <a href="https://www.spdrs.com/general/privacy/" target="_blank">Privacy Policy</a> below. </div>
            </div>
          </div>
          <!--close email header -->
          <div class="email_header_left">
      ...
      <div id="fb-panel">
        ...
        <div id="fbcontent" class="clear"></div><div class="clear"></div>
      </div>
      <!-- close fb panel -->
      <div id="emailbox_backlight"></div>
      <!-- /lightbox -->
    ...
    <div class="content_header_login_container">
      ...
      <div id="lightbox-panel">
        ...
        <div id="showfrgtpsw">
          ...
          <div class="frgt_psw_content">Please enter the words you see in the box, in order and separated by a space.
          	<div id="captchaForgot"></div>
          	</div>
